...
export default function Navbar({ user, onLogout, theme, onToggleTheme }) {
  ...
  return (
    <header className="border-b border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-[#090D16]/90 backdrop-blur-md sticky top-0 z-20 transition-colors">
