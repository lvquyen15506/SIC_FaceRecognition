...
from core import build_model, InfoNCELoss
from utils import save_history, plot_training_history
...
def main():
    ...
    print(f"=== BAT DAU HUAN LUYEN SIC FACEVIT ({cfg.experiment_name}) ===")
    for epoch in range(cfg.epochs):
        epoch_start = time.perf_counter()
        train_metrics = train_one_epoch(model, loaders["train_triplet"], optimizer, criterion, device)
        val_metrics = evaluate(model, loaders["val_triplet"], criterion, device)
